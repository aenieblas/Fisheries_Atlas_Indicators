...
gear_plot_description<-'Global annual catches in thousand tons by major gear type. Global catches can be browsed by species or gear. Data that are displayed on the plot can be downloaded as a csv file. Gear codes are derived from the ISS CFG codes.'
...
ui <- bootstrapPage(
  ...
  navbarPage(theme = shinytheme("flatly"), collapsible = TRUE,
             ...
             #                          value= range(catch_global$YEAR, na.rm=T),
             #                          timeFormat="%Y"),
             #              
             ...
             #            mainPanel(
             #              tabsetPanel(
             #                tabPanel("Annual captures by Ocean or Region", plotOutput("region_plot")),
             #                h5(plot_description)
             #                
             #                #,
             #                
